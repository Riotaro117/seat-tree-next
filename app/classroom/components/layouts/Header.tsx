    ...
    <header className="bg-white border-b border-wood-200 sticky top-0 z-30 shadow-sm">
      <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
        <div className="flex items-center gap-2">
          <Link href={'/classroom'} className="cursor-pointer w-15 h-15">
            <Image
          ...
          <div className="">
            <Link href={'/classroom'} className="cursor-pointer">
            ...
            <div className="bg-orange-100 rounded-lg text-sm font-bold font-serif text-center">
              {!user.is_anonymous ? (
                ...
                <Link
                  href={'/user/update'}
                  className="cursor-pointer px-1 bg-red-400 rounded-lg text-[12px] font-bold font-serif text-center hover:bg-red-600 sm:px-10 sm:text-sm"
                >
                  ユーザー登録はこちらから！！
                </Link>
              )}
